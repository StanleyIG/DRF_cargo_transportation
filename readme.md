...
# 👆 эта ссылка 👆 не работает, поэтому я сздал свои фикстуры. Файл fixtures.json для занесения локаций в базу, а также команду на создание 20 Траков management/commands/create_trucks.py
> 
